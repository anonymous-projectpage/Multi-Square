...
class Multi2:
    def __init__(self, args):
        ...
        high_path = f"{args['check_path']}/{args['benchmark']}/multi_bc/{args['model_name']}/0.0001/place/2025-12-30_12-36/best"
        
        BC_AGENT.load_high_policy(self, high_path)
        low_path = f"{args['check_path']}/{args['benchmark']}/multi_rl/{args['model_name']}/place/1e-05/warmup/2025-12-30_15-22"
